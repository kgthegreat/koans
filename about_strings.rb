...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    hi << there
    # kg surprised
    # kg << does no type conversion on the right hand. but it changes the lefthand operator unlike +
  ...
  in_ruby_version("1.8") do
    def test_you_can_get_a_single_character_from_a_string_1_8
      string = "Bacon, lettuce and tomato"
  ...
  in_ruby_version("1.9") do
    def test_you_can_get_a_single_character_from_a_string_1_9
      string = "Bacon, lettuce and tomato"
